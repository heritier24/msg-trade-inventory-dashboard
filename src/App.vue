...
<script>
import SideMenu from '../src/components/globalComponents/SideMenu.vue'
import FooterMenu from '../src/components/globalComponents/FooterMenu.vue'
import HeaderItem from '../src/components/globalComponents/HeaderItem.vue'
export default {
  components: {
    SideMenu,
    FooterMenu,
